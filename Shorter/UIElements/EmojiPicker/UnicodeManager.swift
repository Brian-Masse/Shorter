...
final class UnicodeManager {
    ...
    fileprivate func getEmojisForCurrentIOSVersion() -> [EmojiCategory] {
        let frequentlyUsedEmojis: EmojiCategory = .init(
            type: .frequentlyUsed,
            categoryName: EmojiCategory.EmojiCateogryType.frequentlyUsed.rawValue,
    ...
    func getFrequentlyUsedEmojis() -> [Emoji] {
        Array(
            defaultEmojis
                .flatMap({ $0.emojis })
                .filter({ $0.usage > 0 })
                .sorted(by: { emoji1, emoji2 in
                    let (usage1, usage2) = (emoji1.usage, emoji2.usage)
                    guard usage1 != usage2 else {
                        return emoji1.lastUsage > emoji2.lastUsage
                    }
    ...
    var defaultEmojis: [EmojiCategory] {
        [
            peopleEmojis,
            natureEmojis,
            foodAndDrinkEmojis,
    ...
    private let peopleEmojis: EmojiCategory = .init(
        type: .people,
        categoryName: EmojiCategory.EmojiCateogryType.people.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F600],
    ...
    private let natureEmojis: EmojiCategory = .init(
        type: .nature,
        categoryName: EmojiCategory.EmojiCateogryType.nature.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F435],
                isSkinToneSupport: false,
    ...
    private let foodAndDrinkEmojis: EmojiCategory = .init(
        type: .foodAndDrink,
        categoryName: EmojiCategory.EmojiCateogryType.foodAndDrink.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F347],
                isSkinToneSupport: false,
    ...
    private let activityEmojis: EmojiCategory = .init(
        type: .activity,
        categoryName: EmojiCategory.EmojiCateogryType.activity.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F383],
                isSkinToneSupport: false,
    ...
    private let travelAndPlacesEmojis: EmojiCategory = .init(
        type: .travelAndPlaces,
        categoryName: EmojiCategory.EmojiCateogryType.travelAndPlaces.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F30D],
                isSkinToneSupport: false,
    ...
    private let objectEmojis: EmojiCategory = .init(
        type: .objects,
        categoryName: EmojiCategory.EmojiCateogryType.objects.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F453],
                isSkinToneSupport: false,
    ...
    private let symbolEmojis: EmojiCategory = .init(
        type: .symbols,
        categoryName: EmojiCategory.EmojiCateogryType.symbols.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F3E7],
                isSkinToneSupport: false,
    ...
    private let flagEmojis: EmojiCategory = .init(
        type: .flags,
        categoryName: EmojiCategory.EmojiCateogryType.flags.title,
        emojis: [
            Emoji(
                emojiKeys: [0x1F3C1],
                isSkinToneSupport: false,
